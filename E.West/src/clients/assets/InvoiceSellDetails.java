...
public class InvoiceSellDetails {
    ...
    public InvoiceSellDetails(int id, String product, String amount, String cost, String totalcost) {
        this.id = id;
    ...
    public InvoiceSellDetails(int id, ObservableList<StoreProducts> data, String selectedpro, String amount, String cost, String totalCostString) {
        this.id = id;
    ...
    public static ObservableList<InvoiceSellDetails> getData(int id, int invoiceId) throws Exception {
    ...
    public static ObservableList<InvoiceSellDetails> getDataForExite(int id) throws Exception {
        ObservableList<InvoiceSellDetails> data = FXCollections.observableArrayList(); 
        ...
        while (rs.next()) {
            data.add(new InvoiceSellDetails(rs.getInt(1), rs.getString(2), rs.getString(3), rs.getString(4), rs.getString(5)));
        }
        return data;
    }
}
