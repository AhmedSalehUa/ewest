 ...
 * @author AHMED
 */
public class PermissionReturnedClientController implements Initializable {

    @FXML
    private TableView<InvoiceReturn> invoiceTable;
    @FXML
    private TableColumn<InvoiceReturn,String> invoiceTabNotes;
    @FXML
    private TableColumn<InvoiceReturn,String> invoiceTabUser;
    @FXML
    private TableColumn<InvoiceReturn,String> invoiceTabTotal;
    @FXML
    private TableColumn<InvoiceReturn,String> invoiceTabDate;
    @FXML
    private TableColumn<InvoiceReturn,String> invoiceTabInvoice;
    @FXML
    private TableColumn<InvoiceReturn,String> invoiceTabId;
    @FXML
    private TableView<InvoiceReturnDetails> invoiceDetailsTable;
    @FXML
    private TableColumn<InvoiceReturnDetails,String> invoiceDetailsTabReturned;
    @FXML
    private TableColumn<InvoiceReturnDetails,String> invoiceDetailsTabProduct;
    @FXML
    private TableColumn<InvoiceReturnDetails,String> invoiceDetailsTabId;
    @FXML
    private Button save;
    @FXML
...
private void getData() throws Exception {
        invoiceDetailsTable.setItems(null);
        invoiceTable.getSelectionModel().clearSelection();
        invoiceTable.setItems(InvoiceReturn.getData());
    }
    ...
    private void getInvoiceDetails(int id) {
        try {
            invoiceDetailsTable.setItems(InvoiceReturnDetails.getDataForExite(id));
        } catch (Exception ex) {
            AlertDialogs.showErrors(ex);
        }
    }
