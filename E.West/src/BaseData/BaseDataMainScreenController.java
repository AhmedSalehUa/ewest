 ...
 * @author AHMED
 */
public class BaseDataMainScreenController implements Initializable {
                                    ...
                                    try {
                                        ...
                                        client.addEventHandler(MouseEvent.MOUSE_CLICKED, (e) -> {
                                            try {
                                                ...
                                                if (User.canAccess("BaseDataClients")) {
                                                    node = FXMLLoader.load(getClass().getResource("/BaseData/Clients.fxml"));
                                        ...
                                        providers.addEventHandler(MouseEvent.MOUSE_CLICKED, (e) -> {
                                            try {
                                                ...
                                                statistic.setId("navBtn");
                                                Parent node = FXMLLoader.load(getClass().getResource(NoPermission));
                                                if (User.canAccess("BaseDataProviders")) {
                                                    node = FXMLLoader.load(getClass().getResource("/BaseData/Providers.fxml"));
                                                    node.getStylesheets().clear();
                                                    node.getStylesheets().add(getClass().getResource("/assets/styles/" + prefs.get(THEME, DEFAULT_THEME) + ".css").toExternalForm());
                                                }
                                                borderpane.setCenter(node);
                                        ...
                                        products.addEventHandler(MouseEvent.MOUSE_CLICKED, (e) -> {
                                            try {
                                                ...
                                                statistic.setId("navBtn");
                                                Parent node = FXMLLoader.load(getClass().getResource(NoPermission));
                                                if (User.canAccess("BaseDataProducts")) {
                                                    node = FXMLLoader.load(getClass().getResource("/BaseData/Products.fxml"));
                                                    node.getStylesheets().clear();
                                                    node.getStylesheets().add(getClass().getResource("/assets/styles/" + prefs.get(THEME, DEFAULT_THEME) + ".css").toExternalForm());
                                                }
                                                borderpane.setCenter(node);
